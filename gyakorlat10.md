...
ORDER BY megjelenés DESC# 10. gyakorlat - feladatok
...
```js
RPUSH tantargyak "programozas alapjai" "matematika" "adatbaziskezeles" "operációsrendszerek"
...
```js
KEYS *a* "(csak akkor szabad ha kevés kulcs van)"
